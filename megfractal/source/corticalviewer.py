...
from mne.viz.utils import _check_option, _show_help, _get_color_list,\
    tight_layout
from mne.externals.decorator import decorator
from mne.source_space import vertex_to_mni
from mne.utils import _ReuseCycle
from mne.viz._brain._timeviewer import ShowView, MplCanvas, IntSlider,\
    TimeSlider, UpdateColorbarScale, BumpColorbarPoints, SmartSlider,\
    _LinkViewer
...
class _TimeViewer(object):
    ...
    def __init__(self, brain, show_traces=False):
        from mne.viz.backends._pyvista import _require_minimum_version
    ...
    def configure_sliders(self):
        ...
        rng = (self.brain._data['clim']['lims'][0],
               self.brain._data['clim']['lims'][2])
        # Orientation slider
    ...
    def configure_point_picking(self):
        from mne.viz.backends._pyvista import _update_picking_callback
        if self.show_traces:
...
#             time_viewer.toggle_playback()
    ...
    #     from mne.viz.backends._pyvista import _update_slider_callback
    #     for time_viewer in self.time_viewers:
